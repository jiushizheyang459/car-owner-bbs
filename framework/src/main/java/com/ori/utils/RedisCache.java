...
public class RedisCache
{
     ...
     * @return 增加后的值
     */
    public Long incrementCacheObjectValue(final String key, int delta) {
    ...
    /**
     * 向 Set 集合中添加一个值，并返回是否为新值
     * SETNX命令确保幂等性
     *
     * @param key   Redis 键
     * @param value 缓存的数据
     * @return true 表示该值是新添加的（Set 之前不存在此值），false 表示该值已经存在
     */
    public <T> Boolean setCacheSetValue(final String key, final T value) {
